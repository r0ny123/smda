...
class SmdaConfig:
    ...
    GAP_DIRECT_BRANCH_TARGET_LIMIT = 8
    GAP_DIRECT_BRANCH_TARGET_ROUNDS = 4
    GAP_DIRECT_BRANCH_FRONTIER_LIMIT = 128
    GAP_DIRECT_BRANCH_ONLY_WHEN_FUNCTIONS_BELOW = 1200
    GAP_DIRECT_BRANCH_ONLY_WHEN_INSTRUCTIONS_BELOW = 100000
    GAP_DIRECT_BRANCH_SPLIT_MAX_LOST_INSTRUCTIONS = 128
    GAP_INTERIOR_CODE_REF_SPLIT_LIMIT = 128
